...
@Component({
    selector: 'angular-columns-btn',
    templateUrl: './angular-columns-btn.component.html',
    styleUrl: './angular-columns-btn.component.css',
    standalone: false
})
export class AngularColumnsBtnComponent {
